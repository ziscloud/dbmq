...
import com.neuronbit.dbmq.common.stats.StatsItem;
import com.neuronbit.dbmq.common.stats.StatsItemSet;
...
public class ConsumeMessageConcurrentlyServiceTest {
    ...
    @Ignore
    @Test
    public void testPullMessage_ConsumeSuccess() throws InterruptedException, NoSuchFieldException, Exception {
        ...
        com.neuronbit.dbmq.common.protocol.body.ConsumeStatus stats = normalServie.getConsumerStatsManager().consumeStatus(pushConsumer.getDefaultMQPushConsumerImpl().groupName(), topic);
