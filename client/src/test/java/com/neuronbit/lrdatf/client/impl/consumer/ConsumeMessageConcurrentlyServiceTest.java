...
import com.neuronbit.lrdatf.common.stats.StatsItem;
import com.neuronbit.lrdatf.common.stats.StatsItemSet;
...
public class ConsumeMessageConcurrentlyServiceTest {
    ...
    public void testPullMessage_ConsumeSuccess() throws InterruptedException, NoSuchFieldException, Exception {
        ...
        com.neuronbit.lrdatf.common.protocol.body.ConsumeStatus stats = normalServie.getConsumerStatsManager().consumeStatus(pushConsumer.getDefaultMQPushConsumerImpl().groupName(), topic);
