 ...
 */
package com.neuronbit.dbmq.common.message;
...
public class MessageExt extends Message {
    ...
    private InetAddress bornHost;

    private long storeTimestamp;
    private InetAddress storeHost;
    ...
    public MessageExt(int queueId, long bornTimestamp, InetAddress bornHost, long storeTimestamp,
                      InetAddress storeHost, String msgId) {
...
//    }
    ...
    public static ByteBuffer socketAddress2ByteBuffer(final InetAddress address, final ByteBuffer byteBuffer) {
    ...
    public static ByteBuffer socketAddress2ByteBuffer(InetAddress address) {
        ...
        return socketAddress2ByteBuffer(address, byteBuffer);
    }
    ...
    public InetAddress getBornHost() {
        return bornHost;
    }

    public void setBornHost(InetAddress bornHost) {
        this.bornHost = bornHost;
    }

    public String getBornHostString() {
        if (null != this.bornHost) {
            return bornHost.getHostAddress();
        }
    ...
    public InetAddress getStoreHost() {
        return storeHost;
    }

    public void setStoreHost(InetAddress storeHost) {
        this.storeHost = storeHost;
    }
