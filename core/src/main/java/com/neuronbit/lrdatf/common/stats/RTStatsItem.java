...
package com.neuronbit.lrdatf.common.stats;
...
public class RTStatsItem extends StatsItem {
    ...
    public RTStatsItem(String statsName, String statsKey, ScheduledExecutorService scheduledExecutorService, Logger log) {
